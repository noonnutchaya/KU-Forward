...
class AccessoriesImageUpload: UIViewController {
       ...
       @IBOutlet weak var myImageView: UIImageView!
        ...
        override func viewDidLoad() {
            ...
            tapGesture.addTarget(self, action:
                #selector(AccessoriesImageUpload
                    .openGallery(tapGesture:)))
    ...
    extension AccessoriesImageUpload: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    extension AccessoriesImageUpload {
        func uploadImage(_ image:UIImage,completion: @escaping (_ url:URL?) -> ()){
            let now = Date()._CurrentTimeMillis()
        ...
        func saveImage(name: String,profileURL:URL ,completion: @escaping ((_ url:URL?) -> ())) {
            ...
            self.ref.child("Accessories").childByAutoId().setValue(dict)

        }
    }

    extension Date {
        func _CurrentTimeMillis() -> Int64 {
