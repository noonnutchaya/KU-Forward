...
class ClothesImageUpload: UIViewController {
            ...
            override func viewDidLoad() {
                ...
                tapGesture.addTarget(self, action:
                    #selector(ClothesImageUpload.openGallery(tapGesture:)))
        ...
        extension ClothesImageUpload: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
        ...
        extension ClothesImageUpload {
            ...
            self.ref.child("Clothes").childByAutoId().setValue(dict)
